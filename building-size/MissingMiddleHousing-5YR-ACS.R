...
#---------------------Chart Initial Results------------------------

# library(psrctrends)
# library(psrcplot)
# 
# #Plot Renter Units
# mmh_renter_analysis <- mmh_renter %>%
...
#             moe = moe)
# 
# mmh_renter_analysis$year <- as.factor(mmh_renter_analysis$year)
# 
# plot_mmh_renter <- create_facet_bar_chart(t=mmh_renter_analysis, w.x="year", w.y="estimate",
#                                           f="name", g="name", w.moe="moe",
#                                           est.type="number")
# plot_mmh_renter
# 
# 
# #Plot Owner Units
# mmh_owner_analysis <- mmh_owner %>%
#   filter(building_size == "2-19 units") %>%
#   transmute(name = name,
#             year = year,
#             building_size = building_size,
...
#             moe = moe)
# 
# mmh_owner_analysis$year <- as.factor(mmh_owner_analysis$year)
# 
# plot_mmh_owner <- create_facet_bar_chart(t=mmh_owner_analysis, w.x="year", w.y="estimate",
#                                           f="name", g="name", w.moe="moe",
#                                           est.type="number")
# plot_mmh_owner
...
saveWorkbook(work_book, file = "MiddleHousingByTenure.xlsx", overwrite = TRUE)
